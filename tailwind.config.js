  ...
  theme: {
    extend: {
      ...
      fontFamily: {
        ...
        display: ['CP_Font', 'Instrument Serif', 'Georgia', 'serif'],
        title: ['CP_Font', 'system-ui', 'sans-serif'],
      },
      fontSize: {
      ...
      boxShadow: {
        ...
        glow: '0 0 40px rgba(217, 70, 239, 0.15)',
        'glow-lg': '0 0 80px rgba(217, 70, 239, 0.2)',
      },
      animation: {
